...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "x",  function () awful.util.spawn( "powerm" ) end,
    ...
    awful.key({ modkey1, altkey   }, "k", function() awful.util.spawn( "powerm" ) end,
        {description = scrlocker, group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "l", function() awful.util.spawn( "powerm" ) end,
        {description = scrlocker, group = "alt+ctrl"}),
